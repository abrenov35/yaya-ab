...
rep("const LABELS={marche:'Marché',depenses:'Dépenses',charges:'Charges',documents:'Documents'};","const LABELS={marche:'Marché',depenses:'Dépenses',charges:'Charges',documents:'Documents',mail:'Mail'};");
rep("const EMPTY_LABELS={marche:'Aucun devis',depenses:'Aucune dépense',charges:'Aucune charge',documents:'Aucun document'};","const EMPTY_LABELS={marche:'Aucun devis',depenses:'Aucune dépense',charges:'Aucune charge',documents:'Aucun document',mail:'Aucun mail'};");
rep("const EMPTY_META={marche:'0 €',depenses:'0 €',charges:'0 €',documents:''};","const EMPTY_META={marche:'0 €',depenses:'0 €',charges:'0 €',documents:'',mail:''};");
