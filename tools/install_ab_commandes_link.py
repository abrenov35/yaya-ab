...
new='yaya-ab-commandes-link.js?v=commandes-link-8'

if new in s:
    print('AB COMMANDES v8 déjà chargé')
    raise SystemExit(0)
...
if not replaced:
    ...
    s=s[:end] + "+'<script src=\"yaya-ab-commandes-link.js?v=commandes-link-8\"><\\/script>'" + s[end:]

p.write_text(s,encoding='utf-8')
print('AB COMMANDES v8 chargé dans Yaya - iframe uniquement à ouverture Commande')
