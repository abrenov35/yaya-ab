...
#yayaDevisViewer .ydd-modal.docs .ydd-head{flex-wrap:nowrap!important;gap:10px!important}
#yayaDevisViewer .ydd-head .ydd-title{flex:0 0 auto;white-space:nowrap}
...
function renderViewer(cid){
  ...
  if(a.length){
    const head=o.querySelector('.ydd-head'),tabs=o.querySelector('.ydd-tabs'),actions=o.querySelector('.ydd-actions');
    if(head&&tabs&&actions)head.insertBefore(tabs,actions);
  }
  o.onclick=e=>{
